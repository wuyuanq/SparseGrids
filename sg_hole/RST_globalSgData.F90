...
module RST_globalSgData
    ...
    integer, parameter :: MAXLAYER = 7 !!
    real(kind=8), parameter :: PMIN = 5.8D7 !1.98D6 !
    real(kind=8), parameter :: PMAX = 6.2D7 !2.12D6 !
    ...
    real(kind=8), parameter :: EQUALPREC = 1.D-8
    ...
    endtype queueNode
    type(queueNode), pointer :: head, tail
