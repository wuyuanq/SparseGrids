...
module RST_globalSgData
    ...
    character(len=*), parameter :: HASHPREFIX = '/Users/yuanqingwu/research/SparseGrids/sg_general/Case4/'
...
#elif NN
    integer, parameter :: SURPLUSSIZE = 2*DIM
#endif
    integer, parameter :: MAXLAYER = 9 !!
...
#elif NN
    real(kind=8), parameter :: RESIDUALPREC = 1.D-5
#endif
    ...
    real(kind=8), dimension(1:SURPLUSSIZE) :: yprec
